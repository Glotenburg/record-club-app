...
const AlbumCard = ({ 
  ...
  return (
    <li className="bg-slate-800 rounded-lg p-5 mb-5 shadow-lg border border-slate-700 hover:shadow-amber-900/10 transition-shadow duration-300 flex flex-col sm:flex-row sm:items-start gap-5">
      {/* Display Cover Art */}
      {album.coverArtUrl && (
        <img 
      ...
      <div className="flex-grow">
        ...
        {/* Trivia Section with Admin Controls */}
        <div className="mb-3">
          {/* Trivia Actions */}
